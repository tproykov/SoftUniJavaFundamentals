...
// A Poke Mon is a special type of pokemon which likes to Poke others. But at the end of the day, the
// Poke Mon wants to keep statistics about how many pokes it has managed to make.
...
//Your task is to start subtracting M from N until N becomes less than M, i.e. the Poke Mon does not have
// enough power to reach the next target.
//Every time you subtract M from N, that means you've reached a target and poked it successfully. COUNT
// how many targets you've poked – you'll need that count.
